...
import { ChevronRight, MapPin, UserX, Lock, TrendingDown } from "lucide-react"
              ...
              <div className="md:w-1/4 flex flex-row md:flex-col gap-2 mt-3 md:mt-0">
                <Link href="https://play.google.com/store" target="_blank" rel="noopener noreferrer" passHref>
                  <Button
                    variant="outline"
                    size="sm"
                    className="border-gray-300 text-gray-700 hover:bg-primary/10 hover:border-primary hover:text-primary transition-all duration-300 flex items-center justify-center gap-2 group text-sm bg-transparent"
                  >
                    <svg
                      viewBox="0 0 24 24"
            ...
            <div className="flex flex-col md:flex-row gap-8 items-center">
              <div className="md:w-1/2">
                <div className="relative h-[300px] w-full rounded-xl overflow-hidden shadow-md">
                  <Image
                    src="/images/design-mode/122412430.jpg"
                ...
                <div className="flex gap-2">
                  <Link href="https://play.google.com/store" target="_blank" rel="noopener noreferrer" passHref>
                    <Button
                      variant="outline"
                      size="sm"
                      className="border-gray-300 text-gray-700 hover:bg-primary/10 hover:border-primary hover:text-primary transition-all duration-300 flex items-center justify-center gap-1 text-xs bg-transparent"
                    >
